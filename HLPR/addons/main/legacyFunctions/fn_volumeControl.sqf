...
private _icon = switch true do
{
	case ( _newValue <= 0 ) :
	{
		"x\HLPR\addons\main\icons\speaker_off.paa";
	};
	case ( _newValue < 0.40 ) :
	{
		"x\HLPR\addons\main\icons\speaker_low.paa";
	};
	case ( _newValue < 0.80 ) :
	{
		"x\HLPR\addons\main\icons\speaker_high.paa";
	};
	default { "x\HLPR\addons\main\icons\speaker_full.paa" };
};
