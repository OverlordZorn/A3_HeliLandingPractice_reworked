...
// FOR EXAMPLE, YOU WANT TO ADD CLASS "AIR2" TO AIR VEHICLE SPAWNER. ADD IT ON LINE 83 RIGHT AFTER "rhs_vehclass_helicopter".
		...
		// SHIPS and Submarines
					...
					{
		// HELI only
						if ((count VVS_Air == 0) && (_vehicleClass in ["Air","rhs_vehclass_aircraft","rhs_vehclass_helicopter","gm_vc_prototype"]) && _className isKindOf "Helicopter") then
